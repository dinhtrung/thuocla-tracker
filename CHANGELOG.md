...
- **Bảng So sánh: cả 3 cột cùng layout 2 dòng** — ô Hôm nay và Ít nhất đổi sang giống cột Trung bình: dòng 1 giờ (kèm icon thói quen ☕) → dòng 2 phút từ điếu trước ± lệch mục tiêu (⚠️ −X / ✅ +X); căn trái – giữa – phải cho 3 cột, bỏ số thứ tự #; bỏ icon đồng hồ ⏰/⏱️ thừa ở đầu 2 dòng
### 🐛 Fixes
